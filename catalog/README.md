...
2. Use capabilities to determine whether a proposal addresses a real institutional need.
3. Use tools to assess sovereignty, portability, and vendor dependency trade-offs.
...
6. Use examples to understand what concrete governed assets or controls may be required.
...
- [Praxeology](praxeology/README.md)
- [Axiology](axiology/README.md)
