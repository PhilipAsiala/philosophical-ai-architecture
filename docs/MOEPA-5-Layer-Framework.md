...
- Architects: read the [Full Architecture Specification](../ARCHITECTURE.md) and [Governance Guidelines](MOEPA-Architectural-Governance-and-Evolution-Guidelines.md) for implementation depth
