...
| **Data Substrate** | The agency-owned knowledge library — truth, values, rules, and lineage in open formats | Always a physical metaphor; never a "vendor database" |
| **MOEPA Catalog** | The routing and governance catalog — discoverability, deduplication, versioning, intake evidence | Federal intake lever; demand management |
...
Introduce the **MOEPA 5-Layer Framework** as their engineering blueprint — not a slide-deck abstraction, but the control plane for how institutional knowledge is classified, stored, verified, acted on, and governed.

---

## 4. Pitching Federal Leadership (The Buyers)

**The hook:** You cannot govern an AI mind with standard IT infrastructure metrics. You need a **cognitive control plane**.

**The governance lever:** Position the **MOEPA 5-Layer Framework** as the agency's go/no-go project intake rubric. Area leaders must prove how their project enriches the **MOEPA Catalog**. Black-box vendor solutions that cannot map to all five layers are rejected by design.
...
- **Voice:** Punchy, authoritative, direct. Engineer-to-engineer. Executive-to-executive.
- **Clarity:** Ground abstract philosophy in physical metaphors — Data Substrate, Control Plane, Management Lever, Catalog.
- **Actionable output:** Every README section, leader guide, diagram, and catalog entry must reinforce the transition from abstract philosophy to a governed, enterprise-ready Data Substrate.
...
- [Federal Leader Guide](moepa-federal-leaders-guide.md) — government intake and ownership pitch
