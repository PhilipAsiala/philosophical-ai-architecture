...
The MOEPA framework enables automation *with* accountability.
...
**Sources collected:**
- SSA wage records (prior year W-2 data)
- State wage record system (quarterly employer-reported wages)
- IRS unearned income data (if shared under data sharing agreement)
- Prior-year benefits records (any existing income verification from prior enrollment)

**Quality validation:**
- SSA records for both adult household members found — quality status: VERIFIED
- State wage records for one adult — current quarter data available, prior quarters: VERIFIED
- No IRS unearned income data (data sharing agreement not in place for this agency)
...
- Adult 1: confirmed identity, linked to employment history and SSA wage record
...
|---|---|---|---|
| SSA W-2 wages (prior year) | $24,800 | $12,400 | Prior year; may not reflect current |
